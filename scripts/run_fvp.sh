...
# FVP=/home/huangtianhao/FVP_ARM_Std_Library/FVP_Base/FVP_Base_AEMvA-AEMvA
...
function generate_plugin_cmds {
  ...
  # local trace_plugin=/home/huangtianhao/ARM/FastModelsPortfolio_11.20/plugins/Linux64_GCC-7.3/GenericTrace.so
  # local toggle_plugin=/home/huangtianhao/ARM/FastModelsPortfolio_11.20/plugins/Linux64_GCC-7.3/ToggleMTIPlugin.so


  # local trace_src="FVP_Base_RevC_2xAEMvA.cluster0.cpu3.INST"
  local trace_src="INST"
  local trace_cmds="-C TRACE.GenericTrace.trace-sources=$trace_src -C TRACE.GenericTrace.trace-file=dp-trace-generic.log"
  ...
  # echo "--plugin=$trace_plugin --plugin=$toggle_plugin $toggle_cmds"
}
